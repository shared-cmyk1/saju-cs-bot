...
CREATE TABLE saju_cs_messages (
    ...
    source TEXT NOT NULL DEFAULT 'ai' CHECK (source IN ('ai', 'human', 'user', 'system')),
...
-- 6. Pending Responses (건별 승인 대기 큐)
